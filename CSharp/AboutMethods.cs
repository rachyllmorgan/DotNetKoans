...
namespace DotNetKoans.CSharp
{
    ...
    public class AboutMethods : Koan
    {
        ...
        {
            Assert.Equal(new string[]{ (string)"Cory", (string)"Will", (string)"Corey" }, this.MethodWithVariableArguments("Cory", "Will", "Corey"));
        }
        ...
        {
            Assert.Equal(new string[] { (string)"Cory", (string)"Will", (string)"Corey" }, this.LocalMethodWithVariableParameters("Cory", "Will", "Corey"));
        }
        ...
        {
            Assert.Equal(new string[] { (string)"Cory", (string)"Will", (string)"Corey" }, LocalMethodWithVariableParameters("Cory", "Will", "Corey"));
        }
